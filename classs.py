...
class Classs:
    def get_all(self):
        return cursor.execute("select class.name as name_class,class.id, teacher.name, teacher.last_name, teacher.id as id_teacher from class join teacher on class.tutor = teacher.id").fetchall()
